...
function PathCard({ path }) {
  return (
    <Link
      to={`/paths/${path.id}`}
      className="block  border border-white/10 bg-white/5 p-4 space-y-2 hover:border-[#A1FF62]/50 hover:bg-white/10 hover:-translate-y-0.5 hover:shadow-lg transition group"
    >
      <div className="flex items-center justify-between gap-2">
        <div className="space-y-1">
          <p className="text-xs uppercase tracking-wide text-[#A1FF62] group-hover:text-[#A1FF62] transition">
            Learning path
          </p>
