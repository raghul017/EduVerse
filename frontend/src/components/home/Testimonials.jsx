...
const testimonials = [
  {
    ...
    quote: "EduVerse completely <span class='text-blue-400 tracking-tighter'>transformed the way</span> I learn React. It keeps me focused, efficient, and aligned — <span class='text-blue-400 tracking-tighter'>without endless tutorials</span> or context switching.",
  ...
  },
  {
    ...
    name: "Michael Chen",
    role: "Data Scientist",
    quote: "The AI roadmaps in EduVerse have <span class='text-blue-400 tracking-tighter'>saved me countless hours</span>. My learning path is optimized, and I can finally focus on what really matters — <span class='text-blue-400 tracking-tighter'>mastering the concepts</span>.",
  ...
  },
  {
    ...
    role: "UX Designer",
    quote: "Switching to EduVerse was the <span class='text-blue-400 tracking-tighter'>best decision</span> I made this year. The resources are curated perfectly, and my progress has <span class='text-blue-400 tracking-tighter'>never been faster</span>.",
  ...
  },
  {
    ...
    quote: "EduVerse's intelligent tracking helps me <span class='text-blue-400 tracking-tighter'>stay on track</span> with confidence. The real-time feedback from the AI tutor is a <span class='text-blue-400 tracking-tighter'>game-changer</span>.",
  ...
  },
  {
    ...
    quote: "From basics to advanced topics, EduVerse makes everything <span class='text-blue-400 tracking-tighter'>effortless and efficient</span>. I've reduced learning time by 40% and my skills have <span class='text-blue-400 tracking-tighter'>skyrocketed</span>.",
...
export function Testimonials() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-20 relative">
      <div className="overflow-hidden rounded-3xl ring-white/10 ring-1 p-6 sm:p-8 relative backdrop-blur border-gradient" style={{ background: 'linear-gradient(225deg,rgba(255,255,255,0.0) 0%,rgba(255,255,255,0.05) 50%,rgba(255,255,255,0.0) 100%)' }}>
        ...
        <section className="relative animate-on-scroll animate delay-100">
          <div className="overflow-hidden ring-white/10 ring-1 rounded-3xl p-6 sm:p-10 relative backdrop-blur border-gradient" style={{ minHeight: '540px', background: 'linear-gradient(225deg,rgba(255,255,255,0.0) 0%,rgba(255,255,255,0.05) 50%,rgba(255,255,255,0.0) 100%)' }}>
            ...
            <div className="flex flex-col justify-between" style={{ minHeight: '420px' }}>
              ...
              <div className="mt-10 flex items-end justify-center gap-3 sm:gap-4 flex-wrap">
                {testimonials.map((t) => (
                  <img 
                    key={t.id}
                    className={`rounded-xl object-cover cursor-pointer transition-all duration-200 hover:opacity-80 ${
                      activeId === t.id 
