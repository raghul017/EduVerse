  ...
  return (
    <section className="flex flex-col max-w-7xl mr-auto ml-auto px-4 lg:px-6 pb-24 gap-12">
      ...
      <div className="flex flex-col items-center text-center animate-enter">
        <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-medium  shadow-[0_0_15px_rgba(59,130,246,0.15)] transition-transform hover:scale-105 cursor-default text-[#FF6B35]">
          <Bot className="w-4 h-4" />
          Neural Processing
        </div>
        <h2 className="text-3xl text-slate-50 md:text-4xl font-bold tracking-tighter">
          Your learning,{' '}
          <span className="bg-clip-text text-transparent bg-gradient-to-r animate-pulse to-[#ff7a4a] from-[#FF6B35] font-bold tracking-tighter">
            supercharged
          </span>
        </h2>
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-3 h-auto gap-y-5">
        ...
        <div className="group flex flex-col overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:bg-slate-900/80 bg-gradient-to-tl via-slate-900/40  p-6 relative  animate-enter hover:shadow-[#ff7a4a]/10 hover:border-[#FF6B35]/30 from-[#FF6B35]/10 to-[#ff7a4a]/10"
          style={{
          ...
          <div className="z-10 flex-1 flex flex-col mb-6 relative justify-center">
            <div className="relative  border border-white/10 bg-slate-950/50 p-4 shadow-2xl transition-colors group-hover:bg-slate-950/80">
              {/* Chat Bubble */}
              <div className="mb-3 flex items-center gap-2">
                <Bot className="w-4 h-4 text-slate-500" />
                <div className=" bg-white/5 px-3 py-1.5 text-[11px] text-slate-200 border border-white/5 transition-colors group-hover:border-[#FF6B35]/20">
              ...
              <div className="grid grid-cols-2 gap-2">
                {[Bot, FileText, Wand2, Scissors].map((Icon, i) => (
                  <button key={i} className="flex items-center gap-2  border border-white/5 bg-white/5 p-2 transition-all hover:bg-white/10 hover:scale-105 active:scale-95">
        ...
        <div className="group flex flex-col overflow-hidden md:col-span-2 bg-gradient-to-tl via-slate-900/40  px-6 py-6 relative transition-all duration-300 hover:shadow-2xl hover:bg-slate-900/60 animate-enter from-[#FF6B35]/20 to-[#ff7a4a]/20 hover:shadow-[#ff7a4a]/10 hover:border-[#FF6B35]/30"
          style={{
            '--border-gradient': 'linear-gradient(315deg, rgba(59, 130, 246, 0.2), rgba(59, 130, 246, 0), rgba(59, 130, 246, 0.2))',
            '--border-radius-before': '24px',
            animationDelay: '0.2s'
        ...
        <div className="group flex flex-col overflow-hidden hover:bg-slate-900/60 hover:shadow-xl transition-all bg-gradient-to-tl via-slate-900/40  p-6 relative  animate-enter from-[#FF6B35]/20 to-[#ff7a4a]/20"
          style={{
            '--border-gradient': 'linear-gradient(315deg, rgba(59, 130, 246, 0.2), rgba(59, 130, 246, 0), rgba(59, 130, 246, 0.2))',
            '--border-radius-before': '24px',
            animationDelay: '0.3s'
          ...
          <div className="relative z-10 flex-1 flex flex-col justify-center mb-6">
            <div className="relative w-full  border border-white/5 bg-slate-950 p-4 group-hover:border-white/20 transition-colors">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  {/* Highlight */}
                  <div className="absolute left-1/4 top-[-2px] bottom-[-2px] w-1/3 rounded border transition-all bg-[#FF6B35]/20 border-[#FF6B35]/30 group-hover:border-[#FF6B35]/50 group-hover:bg-[#FF6B35]/30" />
                  {/* Tooltip */}
                  <div className="absolute left-[40%] bottom-full mb-2 flex -translate-x-1/2 items-center gap-2 rounded-full border border-white/10 bg-slate-800 px-2 py-1 shadow-xl transition-all duration-300 opacity-80 group-hover:opacity-100 group-hover:-translate-y-1">
                    <div className="p-1 text-slate-400 cursor-pointer transition-colors hover:text-[#FF6B35]">
        ...
        <div className="group flex flex-col overflow-hidden hover:bg-slate-900/60 hover:shadow-xl transition-all bg-gradient-to-tl via-slate-900/40  p-6 relative  animate-enter from-[#FF6B35]/20 to-[#ff7a4a]/20"
          ...
          <div className="relative z-10 flex-1 flex flex-col justify-center mb-6">
            <div className="relative w-full  border border-white/5 bg-slate-950 p-4 group-hover:translate-y-1 transition-transform duration-500">
              ...
              <div className="flex items-center gap-2">
                <div className="h-5 w-5 rounded-full flex items-center justify-center animate-pulse bg-[#FF6B35]/20">
        ...
        <div className="group flex flex-col overflow-hidden hover:bg-slate-900/60 hover:shadow-xl transition-all bg-gradient-to-tl via-slate-900/40  p-6 relative  animate-enter from-[#FF6B35]/20 to-[#ff7a4a]/20"
          ...
          <div className="relative z-10 flex-1 flex flex-col justify-center mb-6">
            <div className="relative w-full overflow-hidden  border border-white/5 bg-slate-950 p-4 transition-colors group-hover:border-[#FF6B35]/20">
              ...
              {/* Scanner Line */}
              <div className="absolute top-1/2 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent to-transparent shadow-[0_0_8px_#3b82f6] animate-scan opacity-0 group-hover:opacity-100 via-[#FF6B35]" />
            </div>
          </div>
          <div className="mt-auto">
            <h3 className="text-lg font-semibold text-slate-200 transition-colors group-hover:text-[#FF6B35]">
