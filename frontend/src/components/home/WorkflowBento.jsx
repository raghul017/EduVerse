  ...
  return (
    <section className="flex flex-col max-w-7xl mt-24 mr-auto mb-24 ml-auto px-4 lg:px-6 gap-12">
      ...
      <div className="flex flex-col items-center text-center animate-enter">
        <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-medium backdrop-blur hover:bg-white/10 transition-colors cursor-default shadow-[0_0_15px_rgba(59,130,246,0.15)] text-blue-400">
          <Target className="w-4 h-4" />
          Workflow Engine
        </div>
        <h2 className="text-3xl text-slate-50 md:text-4xl font-bold tracking-tighter">
          Complete control from{' '}
          <span className="bg-clip-text text-transparent bg-gradient-to-r animate-pulse to-blue-400 from-blue-200 font-bold tracking-tighter">
            concept to mastery
          </span>
        </h2>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3 gap-y-6">
          ...
          <div className="z-10 flex-1 flex flex-col mb-6 relative justify-between">
            <div className="relative mb-8">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-slate-200 transition-colors group-hover:text-blue-100">
                  Live Progress Sync
                </h3>
            ...
            <div className="relative z-10 space-y-3 rounded-xl border border-white/5 bg-slate-950/50 p-4 transition-all group-hover:border-white/10 group-hover:bg-slate-950/80">
              ...
              <div className="flex items-center gap-2 rounded-lg border border-white/10 bg-slate-900 px-3 py-2 transition-colors group-hover:border-blue-500/30">
                <Search className="w-3.5 h-3.5 text-slate-500 transition-colors group-hover:text-blue-400" />
                ...
                <div className="flex items-center justify-between rounded-lg bg-white/5 p-2 group-hover:bg-white/10 transition-colors cursor-pointer">
                  <div className="flex items-center gap-2">
                    <div className="h-8 w-8 overflow-hidden rounded-full bg-gradient-to-br p-[1px] to-blue-600 from-blue-500">
                      <div className="h-full w-full rounded-full bg-slate-900 flex items-center justify-center text-xs font-semibold text-blue-400">
                        JD
                      </div>
                    </div>
                    <div>
          ...
          <div className="relative z-10 flex h-full flex-col items-center justify-center py-8">
            ...
            <div className="relative flex h-32 w-full max-w-md items-center justify-center">
              ...
              <svg className="absolute inset-0 h-full w-full text-white/10 pointer-events-none">
                <path d="M60 64 L 160 64" stroke="currentColor" strokeWidth="1" className="transition-colors duration-500 group-hover:stroke-blue-500/30" />
                <path d="M380 64 L 280 64" stroke="currentColor" strokeWidth="1" className="transition-colors duration-500 group-hover:stroke-blue-500/30" />
                <path d="M220 100 L 220 120" stroke="currentColor" strokeWidth="1" className="transition-colors duration-500 group-hover:stroke-blue-500/30" />
              </svg>
            </div>
          </div>
              ...
              <div className="relative flex-1 rounded-xl border border-white/5 bg-slate-950/50 p-4 shadow-lg group-hover:border-white/10 group-hover:bg-slate-950/80 transition-colors">
                ...
                <div className="relative flex flex-col gap-2">
                  ...
                  <div className="flex justify-center">
                    <div className="rounded-lg border border-white/10 bg-slate-900 px-3 py-1.5 text-[10px] text-slate-300 shadow-sm cursor-pointer hover:bg-slate-800 hover:border-white/20 transition-colors">
                      Goal: <span className="text-blue-400">Learn Web Development</span>
                    </div>
                  </div>
                  {/* Lines */}
                  <div className="flex justify-center h-4 w-full relative">
                    <div className="absolute top-0 bottom-0 w-px bg-white/10 left-1/2 -translate-x-1/2 transition-colors duration-500 group-hover:bg-blue-500/50" />
                    <div className="absolute bottom-0 h-px w-32 bg-white/10 left-1/2 -translate-x-16 transition-colors duration-500 delay-100 group-hover:bg-blue-500/50" />
                    <div className="absolute bottom-0 h-1 w-px bg-white/10 left-1/2 -translate-x-16 transition-colors duration-500 delay-150 group-hover:bg-blue-500/50" />
                    <div className="absolute bottom-0 h-1 w-px bg-white/10 left-1/2 translate-x-16 transition-colors duration-500 delay-150 group-hover:bg-blue-500/50" />
                  </div>
                  {/* Branches */}
                  <div className="flex justify-center gap-4">
                    <div className="w-24 rounded-lg border border-white/10 bg-slate-800/50 px-2 py-1.5 backdrop-blur-sm hover:scale-105 cursor-pointer transition-all duration-300 hover:border-blue-500/50 hover:bg-blue-500/10">
                      <div className="flex items-center gap-1.5">
                        <span className="h-1.5 w-1.5 rounded-full shadow-[0_0_4px_currentColor] bg-blue-400" />
        ...
        <BentoCard colSpan={1} delay={0.4} gradient="blue">
            ...
            <div className="flex items-start justify-between">
              <div className="flex gap-3 group/profile cursor-pointer">
                <div className="h-10 w-10 overflow-hidden rounded-xl bg-slate-800 group-hover/profile:rotate-3 transition-transform">
                  <div className="h-full w-full flex items-center justify-center text-sm font-bold text-blue-400 bg-gradient-to-br from-blue-500/20 to-blue-600/20">
                    MY
                  </div>
                </div>
                <div>
          ...
          <div className="relative z-10 space-y-3">
            <div className="rounded-lg border border-white/5 bg-slate-950/30 p-3 group-hover:bg-slate-950/50 transition-colors">
              ...
              <div className="mt-2 flex flex-wrap gap-1.5">
                <span className="inline-flex items-center rounded px-1.5 py-0.5 text-[10px] font-medium border hover:scale-105 transition-all cursor-default bg-blue-500/10 text-blue-400 border-blue-500/20 hover:bg-blue-500/20">
                  #React
                </span>
                <span className="inline-flex items-center rounded px-1.5 py-0.5 text-[10px] font-medium border hover:scale-105 transition-all cursor-default bg-blue-500/10 text-blue-400 border-blue-500/20 hover:bg-blue-500/20">
                  #JavaScript
          ...
          <div className="mt-6">
            <h3 className="text-base font-semibold text-slate-200 transition-colors group-hover:text-blue-100">
              Export Ready
            </h3>
